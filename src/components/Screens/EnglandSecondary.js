...
const EnglandSecondary = ({data}) => {
    ...
    const [hiddenTen, setHiddenTen] = useState('hide-content')
    const [hiddenEleven, setHiddenEleven] = useState('hide-content')
    ...
    const handleShowOne = (idx) => {
        ...
        if (hiddenNine === 'hide-content' && idx === 9) {
            ...
            setHiddenNine('hide-content')
                // event
        if (hiddenTen === 'hide-content' && idx === 10) {
            setHiddenTen('show-content')
        }
        else
            setHiddenTen('hide-content')
                        // event
        if (hiddenEleven === 'hide-content' && idx === 11) {
            setHiddenEleven('show-content')
        }
        else
            setHiddenEleven('hide-content')
    }
...
export default EnglandSecondary;